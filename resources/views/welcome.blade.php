...
<head>
    ...
    <title>Weight Loss-Gain App</title>
...
<div class="container col-md-9 border p-4 mt-4 mb-4">
    <div class="col-md-12 mx-auto text-center p-5 border m-4">
        ...
        <h3 class="text-gray-700 dark:text-gray-500">Register, or if You registered Log In!</h3>
    </div>
    <div class="row col-md-12 mx-auto border m-4">
        @if (Route::has('login'))
            @auth
                ...
                @if (Route::has('register'))
                    <div class="col-md-6 d-flex justify-content-center">
                        <a href="{{ route('register') }}"
                           class="text-gray-700 dark:text-gray-500 underline"><h1>Register</h1></a>
                    </div>
                @endif
            @endauth
        @endif
    </div>
    <div class="col-12 col-md-8 border mx-auto m-5">
